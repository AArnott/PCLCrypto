...
public class CryptographicBufferTests
{
    ...
    public void Compare_NullInputs()
    {
        ...
        Assert.Throws<ArgumentNullException>(
            () => WinRTCrypto.CryptographicBuffer.Compare(Array.Empty<byte>(), null!));
        Assert.Throws<ArgumentNullException>(
            () => WinRTCrypto.CryptographicBuffer.Compare(null!, Array.Empty<byte>()));
    }
    ...
    {
        Assert.Equal(string.Empty, WinRTCrypto.CryptographicBuffer.EncodeToHexString(Array.Empty<byte>()));
    }
    ...
    {
        CollectionAssertEx.AreEqual(Array.Empty<byte>(), WinRTCrypto.CryptographicBuffer.DecodeFromHexString(string.Empty));
    }
