...
namespace PCLCrypto
{
    ...
    internal static class RSAParametersExtensions
    {
        ...
        {
            Requires.Argument(p > 0, nameof(p), Strings.MustBePositive);
            Requires.Argument(q > 0, nameof(q), Strings.MustBePositive);
            Requires.Argument(e > 0, nameof(e), Strings.MustBePositive);
            Requires.Argument(n > 0, nameof(n), Strings.MustBePositive);
        ...
        /// <remarks>
        /// This implementation comes from the pseudocode defining <see href="https://en.wikipedia.org/wiki/Extended_Euclidean_algorithm">the inverse(a, n) function</see>
        /// and <see href="https://github.com/bobvanluijt/Bitcoin-explained/blob/master/RSA.js">the javascript sample</see>.
        /// </remarks>
